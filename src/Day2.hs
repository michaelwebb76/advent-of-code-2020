...
part1Solution :: IO ()
part1Solution =
  solution longInput part1Matcher length

part2Solution :: IO ()
part2Solution =
  solution longInput part2Matcher length
...
parseInput =
  let parseData = (,) <$> (parsePasswordRule <* string ": ") <*> some letter
   in (whitespace *> parseData <* whitespace)
